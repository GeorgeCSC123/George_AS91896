...
# image button
start_button = tk.Button(root, image=photo2, command=start_quiz, bd=0, relief="flat", highlightthickness=0, bg="#7ed957", activebackground="#7ed957", cursor="hand2")

#  name entry box
name_entry = tk.Entry(root, font=("Arial", 40), bg="white", fg="black", bd=2, relief="solid", justify="center")

# submit button
submit_button = tk.Button(root, text="Submit Name", command=submit_name, font=("Arial", 35, "bold"), fg="white", bg="black", activebackground="gray20", activeforeground="white", cursor="hand2")
